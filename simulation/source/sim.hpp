...
bool determine_set_passed(sim_data&, int, int);
int simulate_param_set(int, input_params&, sim_data&, rates&, con_levels&, con_levels&, mutant_data[], ofstream*, ofstream*, char**, ofstream*, ofstream*);
int simulate_section(int, input_params&, sim_data&, rates&, con_levels&, con_levels&, mutant_data[], char**, int[]);
...
void knockout(rates& rs, mutant_data&, double[]);
void revert_knockout(rates& rs, mutant_data&, double[]);
int simulate_mutant(int, input_params&, sim_data&, rates&, con_levels&, con_levels&, mutant_data&, features&, char*);
bool model(sim_data&, rates&, con_levels&, con_levels&, mutant_data&);
...
void mRNA_synthesis(sim_data&, double**, con_levels&, st_context&, int[], mutant_data&);
void calc_neighbors_1d(sim_data&, int[], int, int, int);
void calc_neighbors_2d(sim_data&);
double transcription(double**, con_levels&, int, int, double, double, double);
